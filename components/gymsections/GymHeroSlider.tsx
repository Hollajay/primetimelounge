...
const slides = [
  {
    ...
    description:
      "Discover thousands of verified properties for rent and sale across prime locations. From affordable apartments to luxury homes, find your dream property with secure transactions and expert guidance.",
  ...
  },
  {
    ...
    description:
      "Book luxury short-stay accommodations for vacations, business trips, and weekend getaways. Premium amenities, instant booking, and verified hosts ensure memorable experiences every time.",
  ...
  },
  {
    ...
    description:
      "Streamline your real estate business with our comprehensive platform. List properties, manage bookings, schedule inspections, and handle payments all in one place.",
  ...
  },
  {
    ...
    description:
      "Delight tenants with self-service tools, automated reminders, and fast support every step of their journey. Empower residents with real-time updates and transparent communication.",
  ...
  },
  {
    ...
    description:
      "Launch new projects with immersive storytelling, lead nurture, and real-time analytics. Manage inventory, buyers, and agents from a single command center.",
  ...
  },
  {
    ...
    description:
      "Navigate property investments with verified listings, market intelligence, and personalized advisory. From market research to acquisition, we guide you through every step with trusted expertise.",
        ...
        {slides.map((slide, index) => {
          ...
          return (
            ...
            >
              ...
              <div
                className={`slide-bg-image absolute inset-0 ${isActive ? "active" : ""}`}
              >
                <Image
                  src={slide.img}
                  alt={slide.header}
              ...
              {/* Content */}
              <div
                className={`slide-content-wrapper relative z-20 h-full flex items-center justify-center px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 ${isActive ? "active" : ""}`}
              >
                <div className="max-w-7xl w-full">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-8 xl:gap-12 items-center">
                    {/* Text Content */}
                    <div
                      className={`slide-text-content text-center lg:text-left relative w-full lg:max-w-[90%] xl:max-w-full ${isActive ? "animate-in" : ""}`}
                    >
                      ...
                      {/* Badge */}
                      <div
                        className={`inline-block mb-4 md:mb-6 ${isActive ? "fade-in-up" : ""}`}
                        style={{ animationDelay: "0.1s" }}
                      >
                        <span
                          className={`badge-modern px-4 py-2 rounded-full text-sm font-semibold backdrop-blur-md border border-white/30 ${slide.accentColor} bg-white/20`}
                        >
                          {slide.badge}
                        </span>
                      </div>
                      ...
                      <h1
                        className={`slide-title mb-4 md:mb-6 w-full ${isActive ? "fade-in-up" : ""}`}
                      ...
                      >
                        <span className="block text-3xl sm:text-4xl md:text-5xl lg:text-5xl xl:text-6xl font-extrabold leading-tight break-words">
                          <span
                            className={`${slide.accentColor} gradient-text drop-shadow-lg`}
                          >
                      ...
                      {/* Description */}
                      <p
                        className={`slide-description text-base sm:text-lg md:text-xl text-white/95 mb-6 md:mb-8 max-w-full lg:max-w-xl mx-auto lg:mx-0 leading-relaxed drop-shadow-md break-words ${isActive ? "fade-in-up" : ""}`}
                      ...
                      >
                        <a className="modern-cta-btn px-8 py-4 text-lg font-semibold bg-gradient-to-r from-primary to-purple-600 text-white hover:shadow-2xl hover:shadow-primary/50 transition-all duration-300 transform hover:scale-105 rounded-full border-0">
                         <span> {index === 0 ? "Browse Properties" : index === 1 ? "Book Now" : "Get Started"}  </span>
                        </a>
                      </div>
                    </div>
                    ...
                    {/* Image Content */}
                    <div
                      className={`slide-image-wrapper hidden lg:block ${isActive ? "animate-in" : ""}`}
